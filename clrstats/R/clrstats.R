...
#'   have at least two conditions except when `model` is "shapiro".
#'   Only the first two sorted conditions will be used, and all 
#'   other conditions will be ignored. For paired tests, the number of 
...
meansModel <- function(vals, conditions, model, paired=FALSE, reverse=FALSE) {
  ...
  if (model == kModel[12]) {
    # ignore given conditions for Shapiro-Wilk test and create 1 condition
