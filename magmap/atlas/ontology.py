...
def get_label(
        ...
        labels_lookup: Dict[int, Any], scaling: Optional[Sequence[int]] = None,
        level: Optional[int] = None, rounding: bool = False) -> Dict[str, Any]:
...
def get_label_at_level(
        label_id: Union[int, Sequence[int]], labels_lookup: Dict[int, Any],
