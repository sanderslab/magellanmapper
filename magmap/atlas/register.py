...
def make_label_ids_set(labels_ref_path, labels_ref_lookup, max_level,
                       combine_sides):
    """Make a set of label IDs for the given level and sides.
    
    Args:
        labels_ref_path (str): Path to labels reference from which to load
            labels from the original labels if ``max_level`` is None.
        ...
        max_level (int): Integer of maximum ontological level to measure.
        ...
        combine_sides (bool): True to combine corresponding labels from opposite
...
def volumes_by_id(img_paths, labels_ref_path, suffix=None, unit_factor=None,
